...
use crate::multicore::ParallelSliceMut;
...
pub(in crate::plonk) struct Committed<C: CurveAffine> {
    ...
    pub(in crate::plonk) commitment: C, // TODO - understand how this is useful
}

// TODO - consider if this can be moved somewhere else in the new structure
...
impl<C: CurveAffine> Permuted<C> {
    ...
    >(
        ...
        Ok(Committed::<C> {
            ...
            product_poly: z,
            product_blind,
            commitment: product_commitment, // TODO - understand how this is useful
        })
    }
}
...
fn permute_expression_pair_par<C: CurveAffine, P: Params<C>, R: RngCore>(
    pk: &ProvingKey<C>,
    params: &P,
    domain: &EvaluationDomain<C::Scalar>,
    mut rng: R,
...
#[allow(dead_code)]
fn permute_expression_pair_seq<C: CurveAffine, P: Params<C>, R: RngCore>(
    pk: &ProvingKey<C>,
    params: &P,
    domain: &EvaluationDomain<C::Scalar>,
    mut rng: R,
