...
use crate::plonk::mv_lookup::verifier::lookup_read_prepared_commitments;
...
{
    verify_proof(params, vk, strategy, &[instance], transcript, orig_n)
}
    ...
    let lookups_permuted = (0..num_proofs)
        .map(|_| -> Result<Vec<_>, _> {
            ...
            let res = vk
                ...
                .lookups
                .iter()
                .map(|argument| lookup_read_prepared_commitments(transcript))
                .collect::<Result<Vec<_>, _>>();
            #[cfg(not(feature = "mv-lookup"))]
            let res = vk
                .cs
